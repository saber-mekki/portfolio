...
export const experience = [
  {
    ...
    desc:
      'the aures group has decided to migrate its management application developed in Windev to a Responsive Full Web application. Within a team of 5 people,I was in charge of the frontend part. ',
    descBullets: [
  ...
  },
  {
    ...
    desc:
      'Design and Realization of a Web application for online project management. ',
  
  descBullets: [
    ' Technical environment: Reactjs, ReactStrap, Nodejs, Redux'],
  },
  {
    ...
    desc:
      'Design and implementation of an IoT platform for object monitoring ',
  },
]
